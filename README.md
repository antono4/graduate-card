...
Undangan wisuda digital modern dengan estetika **Soft Neo-Brutalism**. Dirancang khusus untuk merayakan momen bersejarah kelulusan Jimmy Randa Putra, S.Kom. dari **Universitas Putra Indonesia YPTK Padang**.
...
- **🎵 Musik Latar**: Pengalaman imersif dengan kontrol musik yang mudah.
...
1. **Clone repositori:**
   ```bash
   git clone https://github.com/username/undangan-wisuda-jimmy.git
   ```
